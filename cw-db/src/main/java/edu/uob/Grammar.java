...
public class Grammar {
  public static enum Keyword {
    ...
    private String str;
    private Keyword(String str) { this.str = str; }
  ...
  public static String getIdAttrName() { return idAttrName; }

  public static boolean isKeyword(String str) { return Keyword.getByString(str) != null; }

  public static boolean isValue(String str) { return false; } // TODO

  public static boolean isSymbol(String str) { return false; } // TODO
